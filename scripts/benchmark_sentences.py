...
def main() -> None:
    ...
    p.add_argument(
        ...
        nargs="*",
        default=None,
        help="Subset of vendor keys: mingyuepinyin rime_ice rime_frost wanxiang rime_wanxiang_with_gram rime_wubi_sentens_wubi86 rime_wubi_sentens_tiger rime_wubi_sentens_ziyuan",
    )
